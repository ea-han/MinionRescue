...
//
//        try {
//            frameHolder.add(ImageIO.read(new File("src/resources/image/entities/enemy1/enemy1_1.png")));
//            frameHolder.add(ImageIO.read(new File("src/resources/image/entities/enemy1/enemy1_2.png")));
//            frameHolder.add(ImageIO.read(new File("src/resources/image/entities/enemy1/enemy1_3.png")));
//            frameHolder.add(ImageIO.read(new File("src/resources/image/entities/enemy1/enemy1_4.png")));
//            frameHolder.add(ImageIO.read(new File("src/resources/image/entities/enemy1/enemy1_5.png")));
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
